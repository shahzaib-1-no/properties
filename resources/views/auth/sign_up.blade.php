                        ...
                        <form class="form-horizontal" action="{{ asset('register') }}" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="last_name"
                                    value="{{ old('last_name') }}"id="inputEmail3" placeholder="Last Name">
                                <i class="fa fa-user"></i>
                                <span class="error">
                                    @error('last_name')
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" value="{{ old('email') }}"
                                    id="inputEmail3" placeholder="Enter email or phone">
                                <i class="fa fa-user"></i>
                                <span class="error">
                                    @error('email')
                                        {{ $message }}
                            ...
                            <div class="form-group d-flex justify-content-between" id="payment-budget">
                                ...
                                <div> <b> Free</b> </div>
                                <div class="form-check"><input class="form-check-input" name="member" value="simple"
                                        type="radio"></div>
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between" id="payment-budget">
                                ...
                                <div> <b> $100</b> </div>
                                <div class="form-check"><input class="form-check-input" name="member" value="verified"
                                        type="radio"></div>
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between" id="payment-budget">
                                ...
                                <div> <b> $200</b> </div>
                                <div class="form-check"><input class="form-check-input" name="member" value="gold"
                                        type="radio"></div>
                            </div>
                            ...
                            <span class="error">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="pt-3">Don’t have an account ? <b> <a href="{{ asset('login') }}"
                                                style="color:#5381F8">
                                                Sign in </a> </b></p>
                                </div>
