...
<head>
    ...
    <title>Properties @yield('tile')</title>
...
<body style="background-color:#E9ECEF;">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        @if (Auth::user()->role == '3')
                            <div class="sb-sidenav-menu-heading">Manage Listing</div>
                            ...
                            <div class="collapse" id="listing" aria-labelledby="headingOne"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" id="add_listing_template">Add Listing</a>
    ...
    <script type="text/javascript"
        src="{{ asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyDMooX0I_jt5VfdVec9sIW03_rO903WrCk&libraries=places') }}">
    </script>
    @if (session('msg'))
        <script>
    ...
    <script>
        $(document).ready(function() {
            $('#add_listing_template').click(function(e) {
                e.preventDefault();
                $.ajax({
                    type: "GET",
                    url: "{{ route('add_listing_template') }}",
                    success: function(response, textStatus, jqXHR) {
                        $('.maint').empty();
                        $('.maint').append(response);
                    },
